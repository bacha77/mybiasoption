...
export class DataSourceManager {
    ...
    async getQuotes(symbols) {
        ...
        try {
            ...
            Object.keys(pythResults).forEach(sym => {
                ...
                if (price <= 0 && fallbacks[sym]) price = fallbacks[sym];
                ...
                if (price > 0) {
                    ...
                    output[sym] = {
                        ...
                        confidence: pyth ? pyth.confidence : 0,
    ...
    async getHistory(symbol, interval, daysBack) {
        ...
        // --- FINAL FALLBACK: Synthetic candles for index symbols (DXY, VIX) ---
        // Generate realistic-looking candles from known reference prices
        const syntheticBases = { 'DX-Y.NYB': 104.2, '^VIX': 18.5, 'DXY': 104.2, 'VIX': 18.5, '^TNX': 4.35, '^GSPC': 5210 };
